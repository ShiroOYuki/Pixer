"""
Django settings for Pixer project.
...
SECRET_KEY = 'django-insecure-fli=b3^nhl6wf5i$-4cibog^dv+(*+voqzusd(eghe7fh(s#2u'
...
WSGI_APPLICATION = 'Pixer.wsgi.application'
