...
class PixerImages(models.Model):
    ...
    uid = models.CharField(unique=True, max_length=20, db_collation='utf8mb4_bin')
    filepath = models.CharField(unique=True, max_length=100, db_collation='utf8mb4_bin', blank=True, null=True)
